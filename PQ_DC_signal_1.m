function [EnDominantFreq,dominantFreq, TimeDomParam]=PQ_DC_signal_1(u,Fs,xDC,t,signalDuration,signalName, Tw, numFigures)
...
%     ui(blockIndex)=u((blockIndex-1)*Fs+1:blockIndex*Fs);
    [EnDominantFreq, dominantFreq]= fftIna_1(u((blockIndex-1)*Fs*Tw+1:blockIndex*Fs*Tw), Fs, signalDuration,blockIndex+numFigures,signalName);
end
 ...
 for dId = 1 : nSeries
    ...
    switch dId
        case 1
            ...
            plot(t,u);
            xlim([0 60]);
            %title(signalName(1:min(length(signalName),10)), 'fontsize', fSize_title, 'fontweight', 'normal');
            title('Signal(t)', 'fontsize', fSize_title, 'fontweight', 'normal');
        ...
        case 2
            ...
            hold off
            title('Mean of the signal @ Tw=1s', 'fontsize', 11, 'fontweight', 'normal');
            xlabel('time (s)', 'FontSize',fSize_label);
            ylabel(ylabel1, 'FontSize',fSize_label);
        ...
        case 3
            ...
            hold off
            title('RMS of the signal @ Tw=1s', 'fontsize', 11, 'fontweight', 'normal');
            xlabel('time (s)', 'FontSize',fSize_label);
            ylabel(ylabel1, 'FontSize',fSize_label);
        case 4
            ...
            hold off
            title('Median=x50% of the signal @ Tw=1s', 'fontsize', fSize_title, 'fontweight', 'normal');
            xlabel('time (s)', 'FontSize',fSize_label);
            ylabel(ylabel1, 'FontSize',fSize_label);
        case 5
            ...
            hold off
            title('Peak-to-peak variation from median', 'fontsize', fSize_title, 'fontweight', 'normal');
        case 6
            ...
            hold off
            title('Peak-to-peak variation from xDC', 'fontsize',fSize_title, 'fontweight', 'normal');
        case 7
            ...
            hold off
            title('75 percentile variation from median', 'fontsize', fSize_title, 'fontweight', 'normal');
        case 8
            ...
            hold off
            title('RMS variation from xDC', 'fontsize', fSize_title, 'fontweight', 'normal');
        case 9
            ...
            hold off
            title('peak-to-peak displacement factor', 'fontsize', fSize_title, 'fontweight', 'normal');
        case 10
            ...
            hold off
            title('75 percentile displacement factor', 'fontsize', fSize_title, 'fontweight', 'normal');
        case 11
            ...
            hold off
            title('xi -asymmetry factor', 'fontsize',fSize_title, 'fontweight', 'normal');
        case 12
            ...
            hold off
            title('xiRMS -RMS variation displacement', 'fontsize',fSize_title, 'fontweight', 'normal');
    ...
    if dId<=4
        ...
        ylabel(ylabel2,'FontSize',fSize_label);
    end
