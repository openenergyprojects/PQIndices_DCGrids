...
Vout114Vector=(VacIacVdcOutWKS.signals(2).values(:,1))';
Vout114_sim=(repmat(Vout114Vector(150:end),1,60))';
xDC=48;
...
Fsampl=ceil(length(t)/max(t)/1000)*1000;
% Fsampl=10000;
signalName='Vout_sim_57dc_48V_114Ohm_60sec';
[EnDominantFreqVout,dominantFreq, TimeDomParam228]=PQ_DC_signal(Vout114_sim(1:signalDuration*Fsampl),Fsampl,xDC,t(1:signalDuration*Fsampl),signalDuration,signalName, Tw);
