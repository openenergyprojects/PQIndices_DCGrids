...
Vin114_60s=Vin114(1:signalDuration*Fsampl114);
Vout114_60s=Vout114(1:signalDuration*Fsampl114);
Vin228_60s=Vin228(1:signalDuration*Fsampl228);
Vout228_60s=Vout228(1:signalDuration*Fsampl228);
...
name='Vin @R=114Ohm & dc=0.57';
title(name, 'fontSize',10)
% signalDuration=60; %signal duration in seconds
signalName='Vin57dc_114Ohm_60sec';
% t=(Measurement_57dc_48V_114Ohm.X.Data)';
% Fsampl=ceil(length(t)/max(t)/1000)*1000;
% xDC=21;
xDCVin114=median(Vin114);
[EnDominantFreqVout, dominantFreq, TimeDomParam114]=PQ_DC_signal_1(Vin114_60s,Fsampl114,xDCVin114,t114_60s,signalDuration,signalName, Tw, numFigures);

numFigures=numFigures+4;
name='Vout @R=114Ohm & dc=0.57';
title(name, 'fontSize',10)
% signalDuration=60; %signal duration in seconds
signalName='Vout57dc_114Ohm_60sec';
% t=(Measurement_57dc_48V_114Ohm.X.Data)';
% Fsampl=ceil(length(t)/max(t)/1000)*1000;
% xDC=21;
xDCVout114=median(Vout114);
[EnDominantFreqVout, dominantFreq, TimeDomParam114]=PQ_DC_signal_1(Vout114_60s,Fsampl114,xDCVout114,t114_60s,signalDuration,signalName, Tw, numFigures);
